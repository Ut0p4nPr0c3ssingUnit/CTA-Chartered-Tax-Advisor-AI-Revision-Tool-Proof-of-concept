# CTA-Chartered-Tax-Advisor-AI-Revision-Tool-Proof-of-concept

Hello all. I have recently started a Graduate Apprentice in Tax. This is a Proof-of-concept AI Revision Tool. Please comment on any issues, suggestions to fix, etc.
...

{
  ...
  "metadata": {
    "colab": {
      "provenance": [],
      "authorship_tag": "ABX9TyOcUyZIcFfC8GkqtiYujCWv",
  ...
  "cells": [
    {
      ...
      "source": [
        "<a href=\"https://colab.research.google.com/github/Ut0p4nPr0c3ssingUnit/AI-Driven-IDS/blob/main/Chartered_Tax_Advisor_(CTA)_Agentic_Model_Producing_Flashcards_based_on_Tolley's_Material.ipynb\" target=\"_parent\"><img src=\"https://colab.research.google.com/assets/colab-badge.svg\" alt=\"Open In Colab\"/></a>"
      ]
    },
    {
      "cell_type": "markdown",
    ...
    },
    {
      ...
      "source": [
        ...
        "                    \"back_technical_truth\": {\"type\": \"STRING\", \"description\": \"Precise answer. If calculations, allowances, thresholds, or multiple rules are involved, you MUST format this answer using a clean Markdown table structure (e.g., using | column | headers |).\"},\n",
        "                    \"visual_layout_hint\": {\n",
        "                        \"type\": \"OBJECT\",\n",
        "                        \"properties\": {\n",
    ...
    },
    {
      ...
      "source": [
        ...
        "        .flashcard-inner { position: relative; width: 100%; height: 100%; transition: transform 0.6s cubic-bezier(0.4, 0, 0.2, 1); transform-style: preserve-3d; box-shadow: 0 10px 15px -3px rgba(0, 0, 0, 0.1); border-radius: 14px; }\n",
        "        .flashcard-container.is-flipped .flashcard-inner { transform: rotateY(180deg); }\n",
        "        .card-front, .card-back { position: absolute; width: 100%; height: 100%; -webkit-backface-visibility: hidden; backface-visibility: hidden; border-radius: 14px; box-sizing: border-box; padding: 22px; display: flex; flex-direction: column; justify-content: space-between; overflow: hidden; }\n",
        ...
        "        .anchor-box { background-color: #f8fafc; border-left: 4px solid #94a3b8; padding: 8px 12px; font-size: 12px; color: #475569; font-style: italic; border: 1px solid #e2e8f0; border-left: 4px solid #3b82f6; border-radius: 4px; }\n",
...
This tool uses Google's Vertex AI and Gemini 1.5 Pro to:
- Parse Tolley's tax reference materials
- Generate interactive flashcards with:
  - Clear revision questions
  - Precise statutory answers
  - Visual layout hints for better retention
  - Mnemonic anchors for memory aid
- Render a beautiful interactive HTML frontend with flip animations

## 🔑 Key Features

- **Schema-Enforced Generation**: Structured JSON output for consistent flashcard format
- **Tax-Specific**: Focused on UK Chartered Tax Advisor (CTA) examination topics
- **Dynamic Prompting**: Customize flashcard generation by topic
- **Interactive Visualizer**: HTML5 frontend with flip animations and session tracking
- **GCP Integration**: Automatic project detection and Cloud Storage integration
...
4. Upload or specify your Tolley's reference PDF
5. Enter the tax topic you want to focus on
6. Generate interactive flashcards
7. View and track your revision progress in the interactive visualizer

## 🛠️ Technologies

- **Python 3** - Core language
- **Google Colab** - Execution environment
- **Vertex AI** - LLM infrastructure
- **Gemini 1.5 Pro** - AI model
- **Google Cloud Storage** - Document storage
- **HTML5/CSS3** - Interactive frontend

## 💬 Feedback & Issues

Please open an issue or comment with:
- Bug reports
- Feature suggestions
- Improvements to the flashcard schema
- UI/UX enhancements
- Tax accuracy feedback

## 📄 License

This project is open for educational and professional development purposes.
